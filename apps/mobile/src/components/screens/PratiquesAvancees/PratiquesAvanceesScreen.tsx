...
import { PRATIQUES_AVANCEES_ITEMS } from '../../../data/fiches-pratiques';
...
export function PratiquesAvanceesScreen({ isAdult: isAdultProp, onNavigate: onNavigateProp }: Props) {
  ...
  return (
    <FichePratiqueScreen
      ...
      namespace="pratiquesAvancees"
      items={PRATIQUES_AVANCEES_ITEMS}
