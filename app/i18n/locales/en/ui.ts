export const ui = {
  ...
  settings: {
    ...
    deleteAccount: {
      ...
      confirmBody: 'This action permanently deletes all your personal data (profile, progress, cards, preferences). Compliant with the GDPR right to erasure (Art. 17). Irreversible.',
  ...
  apprendre: {
    ...
    sexting:              { title: 'Sexting & Intimate Images', desc: 'What we assume vs. what actually happens' },
    pressionManip:        { title: 'Pressure & Manipulation',  desc: "Recognizing what looks like consent but isn't" },
    ruptureHarcele:       { title: 'Breakups & Harassment',    desc: 'What the law protects after a relationship' },
    contentNonConsenti:   { title: 'Non-Consensual Content',   desc: 'Intimate images & videos shared without consent — your rights' },
    pratiquesExplicit:    { title: 'Explicit Practices',       desc: 'Communication before, during and after — what goes unsaid' },
    zonesGrises:          { title: 'Grey Areas',                desc: "Situations where the answer isn't obvious" },
    lgbtqConsent:         { title: 'LGBTQ+ & Consent',          desc: '7 myths about sexual orientation and consent' },
    pratiquesAvancees:    { title: 'Advanced Practices',        desc: 'Bondage, role-play, exploration — boundaries and limits' },
