...
import { CONTENT_NON_CONSENTI_ITEMS } from '../../../data/fiches-pratiques';
...
export function ContentNonConsentiScreen({ isAdult: isAdultProp, onNavigate: onNavigateProp }: Props) {
  ...
  return (
    <FichePratiqueScreen
      ...
      namespace="contentNonConsenti"
      items={CONTENT_NON_CONSENTI_ITEMS}
