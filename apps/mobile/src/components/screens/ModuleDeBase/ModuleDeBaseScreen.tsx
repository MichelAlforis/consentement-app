...
import { MODULE_DE_BASE_ITEMS } from '../../../data/fiches-pratiques';
...
export function ModuleDeBaseScreen({ isAdult: isAdultProp, onNavigate: onNavigateProp }: Props) {
  ...
  return (
    <FichePratiqueScreen
      moduleId="module-de-base"
      namespace="moduleDeBase"
      items={MODULE_DE_BASE_ITEMS}
