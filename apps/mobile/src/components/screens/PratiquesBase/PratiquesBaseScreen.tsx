...
import { PRATIQUES_BASE_ITEMS } from '../../../data/fiches-pratiques';
...
export function PratiquesBaseScreen({ isAdult: isAdultProp, onNavigate: onNavigateProp }: Props) {
