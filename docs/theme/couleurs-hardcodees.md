...
> Dernière mise à jour : 2026-05-03 — 9 passes effectuées.

Neuf passes d'audit effectuées. Ce document trace ce qui a été corrigé, ce qui reste intentionnellement fixe, et ce qui est en attente.
