...
export interface OwnedCard {
  ...
  unlockedBy: string; // 'card-session' | 'slow-session' | module id | topic id
}
  ...
  persist(
    (set, get) => ({
      ...
      drawFromPool: () => {
        ...
        // Retire l'entrée du pool qu'on ait trouvé une carte ou non
        set((s) => ({
    ...
    }),
    {
      ...
      storage: createAppStorage<UnlockStore>(),
    }
  )
);
